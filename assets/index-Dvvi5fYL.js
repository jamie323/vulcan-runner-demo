...
`].filter(Hs).join(`
`)),a=$o(a),a=Mc(a,t),a=wc(a,t),o=$o(o),o=Mc(o,t),o=wc(o,t),a=Tc(a),o=Tc(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+f);const M=b+m+a,v=b+f+o,D=xc(n,n.VERTEX_SHADER,M),A=xc(n,n.FRAGMENT_SHADER,v);n.attachShader(_,D),n.attachShader(_,A),t.index0AttributeName!==void 0?n.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&n.bindAttribLocation(_,0,"position"),n.linkProgram(_);function E(R){if(r.debug.checkShaderErrors){const z=n.getProgramInfoLog(_).trim(),F=n.getShaderInfoLog(D).trim(),W=n.getShaderInfoLog(A).trim();let Y=!0,V=!0;if(n.getProgramParameter(_,n.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(n,_,D,A);else{const J=Sc(n,D,"vertex"),G=Sc(n,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+n.getError()+" - VALIDATE_STATUS "+n.getProgramParameter(_,n.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
            ...
            `}),this.dustPoints=new wn(this.dustGeo,this.dustMat),e.add(this.dustPoints),this.sparkleGeo=new ut;const a=120,o=new Float32Array(a*3),l=new Float32Array(a),c=new Float32Array(a),h=new Float32Array(a*3);this.sparkleData={positions:o,alphas:l,sizes:c,colors:h,velocities:new Float32Array(a*3),count:a,active:new Uint8Array(a)},this.sparkleGeo.setAttribute("position",new Be(o,3)),this.sparkleGeo.setAttribute("alpha",new Be(l,1)),this.sparkleGeo.setAttribute("size",new Be(c,1)),this.sparkleGeo.setAttribute("color",new Be(h,3)),this.sparkleMat=new _t({transparent:!0,depthWrite:!1,vertexShader:`
                attribute float alpha;
                attribute float size;
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([a]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){const n=new Worker(this.workerSourceURL);n._callbacks={},n._taskCosts={},n._taskLoad=0,n.postMessage({type:"init",decoderConfig:this.decoderConfig}),n.onmessage=function(s){const a=s.data;switch(a.type){case"decode":n._callbacks[a.id].resolve(a);break;case"error":n._callbacks[a.id].reject(a);break;default:console.error('THREE.DRACOLoader: Unexpected message, "'+a.type+'"')}},this.workerPool.push(n)}else this.workerPool.sort(function(n,s){return n._taskLoad>s._taskLoad?-1:1});const i=this.workerPool[this.workerPool.length-1];return i._taskCosts[e]=t,i._taskLoad+=t,i})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log("Task load: ",this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==""&&URL.revokeObjectURL(this.workerSourceURL),this}}function rx(){let r,e;onmessage=function(a){const o=a.data;switch(o.type){case"init":r=o.decoderConfig,e=new Promise(function(h){r.onModuleLoaded=function(d){h({draco:d})},DracoDecoderModule(r)});break;case"decode":const l=o.buffer,c=o.taskConfig;e.then(h=>{const d=h.draco,u=new d.Decoder;try{const p=t(d,u,new Int8Array(l),c),g=p.attributes.map(_=>_.array.buffer);p.index&&g.push(p.index.array.buffer),self.postMessage({type:"decode",id:o.id,geometry:p},g)}catch(p){console.error(p),self.postMessage({type:"error",id:o.id,error:p.message})}finally{d.destroy(u)}});break}};function t(a,o,l,c){const h=c.attributeIDs,d=c.attributeTypes;let u,p;const g=o.GetEncodedGeometryType(l);if(g===a.TRIANGULAR_MESH)u=new a.Mesh,p=o.DecodeArrayToMesh(l,l.byteLength,u);else if(g===a.POINT_CLOUD)u=new a.PointCloud,p=o.DecodeArrayToPointCloud(l,l.byteLength,u);else throw new Error("THREE.DRACOLoader: Unexpected geometry type.");if(!p.ok()||u.ptr===0)throw new Error("THREE.DRACOLoader: Decoding failed: "+p.error_msg());const _={index:null,attributes:[]};for(const m in h){const f=self[d[m]];let b,M;if(c.useUniqueIDs)M=h[m],b=o.GetAttributeByUniqueId(u,M);else{if(M=o.GetAttributeId(u,a[h[m]]),M===-1)continue;b=o.GetAttribute(u,M)}const v=n(a,o,u,m,f,b);m==="color"&&(v.vertexColorSpace=c.vertexColorSpace),_.attributes.push(v)}return g===a.TRIANGULAR_MESH&&(_.index=i(a,o,u)),a.destroy(u),_}function i(a,o,l){const h=l.num_faces()*3,d=h*4,u=a._malloc(d);o.GetTrianglesUInt32Array(l,d,u);const p=new Uint32Array(a.HEAPF32.buffer,u,h).slice();return a._free(u),{array:p,itemSize:1}}function n(a,o,l,c,h,d){const u=d.num_components(),g=l.num_points()*u,_=g*h.BYTES_PER_ELEMENT,m=s(a,h),f=a._malloc(_);o.GetAttributeDataArrayForAllPoints(l,d,m,_,f);const b=new h(a.HEAPF32.buffer,f,g).slice();return a._free(f),{name:c,array:b,itemSize:u}}function s(a,o){switch(o){case Float32Array:return a.DT_FLOAT32;case Int8Array:return a.DT_INT8;case Int16Array:return a.DT_INT16;case Int32Array:return a.DT_INT32;case Uint8Array:return a.DT_UINT8;case Uint16Array:return a.DT_UINT16;case Uint32Array:return a.DT_UINT32}}}function Hr(r){const e=r.clone(!0);return e.traverse(t=>{t.isMesh&&t.material&&(t.material=Array.isArray(t.material)?t.material.map(i=>i.clone()):t.material.clone())}),e}const Gr=Math.PI/180;new Ft().setFromAxisAngle(new C(0,0,1),60*Gr),new Ft().setFromAxisAngle(new C(0,0,1),-60*Gr),new Ft().setFromAxisAngle(new C(1,0,0),5*Gr),new Ft().setFromAxisAngle(new C(1,0,0),5*Gr);class ax{constructor(){this.loader=new My;const e=new sx;e.setDecoderPath("https://www.gstatic.com/draco/versioned/decoders/1.5.7/"),this.loader.setDRACOLoader(e),this.knight=null,this.barbarian=null,this.characters={},this.animations=new Map,this.obstacles=new Map,this.scenery=new Map,this.environment=new Map,this.pickups=new Map,this.progress=null}_loadFile(e){return new Promise((t,i)=>{this.loader.load(e,t,void 0,i)})}async load(){const e=[{path:"assets/animations/Rig_Medium_MovementBasic.glb"},{path:"assets/animations/Rig_Medium_MovementAdvanced.glb"},{path:"assets/animations/Rig_Medium_CombatMelee.glb"},{path:"assets/animations/Rig_Medium_General.glb"}],t=["barrel_large","barrel_small","crate_large","crate_small","column","pillar","pillar_decorated","barrier","rocks","chest"],i=["torch_lit","banner_red","banner_blue","pillar_decorated","coin"],n=["Tree_1_B_Color4","Tree_2_B_Color4","Tree_6_B_Color4","Tree_Bare_1_B_Color4","Bush_2_E_Color4","Bush_3_B_Color4","Bush_4_B_Color4","Rock_1_E_Color4","Rock_3_B_Color4","Rock_4_B_Color4","Rock_5_E_Color4","Grass_1_A_Color4","Grass_2_A_Color4"],s=["potion_large_red","potion_large_blue","potion_large_green","potion_large_orange","shield_badge"],a=[];let o=0;const l=()=>{o++,this.progress&&this.progress(o/a.length)};a.push(this._loadFile("assets/characters/Knight.glb").then(c=>{this.knight=c,this.characters.knight=c,l()})),a.push(this._loadFile("assets/characters/Barbarian.glb").then(c=>{this.barbarian=c,this.characters.barbarian=c,l()}));for(const c of e)a.push(this._loadFile(c.path).then(h=>{for(const d of h.animations)this.animations.set(d.name,d);l()}));for(const c of t)a.push(this._loadFile(`assets/obstacles/${c}.gltf`).then(h=>{this.obstacles.set(c,h.scene),l()}));for(const c of i)a.push(this._loadFile(`assets/scenery/${c}.gltf`).then(h=>{this.scenery.set(c,h.scene),l()}));for(const c of n)a.push(this._loadFile(`assets/environment/${c}.gltf`).then(h=>{this.environment.set(c,h.scene),l()}));for(const c of s)a.push(this._loadFile(`assets/pickups/${c}.gltf`).then(h=>{this.pickups.set(c,h.scene),l()}));await Promise.all(a)}getObstacle(e){const t=this.obstacles.get(e);if(!t)throw new Error(`Obstacle not found: ${e}`);return Hr(t)}getScenery(e){const t=this.scenery.get(e);if(!t)throw new Error(`Scenery not found: ${e}`);return Hr(t)}getEnvironment(e){const t=this.environment.get(e);if(!t)throw new Error(`Environment not found: ${e}`);return Hr(t)}getPickup(e){const t=this.pickups.get(e);if(!t)throw new Error(`Pickup not found: ${e}`);return Hr(t)}}const Ct=new f_({antialias:!1,powerPreference:"high-performance"});Ct.setSize(window.innerWidth,window.innerHeight);Ct.setPixelRatio(Math.min(window.devicePixelRatio,2));Ct.shadowMap.enabled=!0;Ct.shadowMap.type=Lh;Ct.toneMapping=Nh;Ct.toneMappingExposure=.95;Ct.outputColorSpace=gt;document.body.appendChild(Ct.domElement);const ct=new m_;ct.background=new de(1706544);ct.fog=new ml(2756672,.008);const ox=new Ss(250,32,16),Jn=new _t({side:zt,fog:!1,depthWrite:!1,uniforms:{topColor:{value:new de(657968)},midColor:{value:new de(4857984)},horizonColor:{value:new de(16736304)},bottomColor:{value:new de(16752720)},uTime:{value:0}},vertexShader:`
    ...
    `}),Od=new we(ox,Jn);ct.add(Od);const nr=150,sr=new ut,Kr=new Float32Array(nr*3),Bd=new Float32Array(nr),Fd=new Float32Array(nr),zd=new Float32Array(nr);for(let r=0;r<nr;r++)Kr[r*3]=(Math.random()-.5)*40,Kr[r*3+1]=Math.random()*12,Kr[r*3+2]=(Math.random()-.5)*80,Bd[r]=Math.random()*Math.PI*2,Fd[r]=.5+Math.random()*2,zd[r]=1.5+Math.random()*4;sr.setAttribute("position",new Be(Kr,3));sr.setAttribute("aPhase",new Be(Bd,1));sr.setAttribute("aSpeed",new Be(Fd,1));sr.setAttribute("size",new Be(zd,1));const Hd=new _t({transparent:!0,depthWrite:!1,fog:!1,blending:$s,uniforms:{uTime:{value:0}},vertexShader:`
    ...
    `}),Gd=new wn(sr,Hd);ct.add(Gd);const zi=80,xs=new ut,Pt=new Float32Array(zi*3),ki=new Float32Array(zi),$t=new Float32Array(zi*3),Vd=new Float32Array(zi);let $n=0;for(let r=0;r<zi;r++)Pt[r*3]=0,Pt[r*3+1]=-100,Pt[r*3+2]=0,ki[r]=0,Vd[r]=2+Math.random()*3;xs.setAttribute("position",new Be(Pt,3));xs.setAttribute("aAlpha",new Be(ki,1));xs.setAttribute("size",new Be(Vd,1));const el=new _t({transparent:!0,depthWrite:!1,fog:!1,blending:$s,uniforms:{uColor1:{value:new C(1,.5,.1)},uColor2:{value:new C(1,.85,.3)}},vertexShader:`
...
`;document.getElementById("ui").appendChild(rr);tl.menu.style.display="none";const il=new ax;il.progress=r=>{document.getElementById("load-bar").style.width=r*100+"%",document.getElementById("load-pct").textContent=Math.floor(r*100)+"%"};const Xd=new Ed;Xd.eagerPreload("music_menu.mp3","music_gameplay.mp3");let Ne;const so=60,hx=78;il.load().then(()=>{Ne=new vy(ct,cn,tl,il,Xd),Ct.compile(ct,cn),Ts.render(),rr.style.display="none",tl.menu.style.display="flex",$d()}).catch(r=>{console.error("Asset loading failed:",r),document.getElementById("load-pct").textContent="Error loading assets!"});window.addEventListener("resize",()=>{const r=window.innerWidth,e=window.innerHeight;cn.aspect=r/e,cn.updateProjectionMatrix(),Ct.setSize(r,e),Ts.setSize(r,e),ss.setSize(r,e),wl.uniforms.resolution.value.set(1/(r*Ct.getPixelRatio()),1/(e*Ct.getPixelRatio()))});const dx=new bd;let ro=0,ao=0;function $d(){requestAnimationFrame($d);const r=Math.min(dx.getDelta(),.05);if(ro+=r,Ne&&Ne.update(r),Jn.uniforms.uTime.value=ro,Hd.uniforms.uTime.value=ro,Ne){const e=Ne.runner?Math.max(0,(Ne.runner.runSpeed-16)/14):0,t=Ne.state===1&&Ne.runner?so+(hx-so)*e:so;cn.fov+=(t-cn.fov)*r*3,cn.updateProjectionMatrix(),Ne._screenFlash&&(Ne._screenFlash.timer-=r,Ne._screenFlash.timer<=0&&(Ne._screenFlash=null))}if(Ne&&Ne.runner){const e=Ne.runner.position.z,t=Ne.runner.position.x;if(xt.position.z=e+15,xt.target.position.z=e,xt.target.updateMatrixWorld(),ns.position.z=e-20,is.position.z=e-5,Od.position.z=e,Gd.position.z=e,Ne.runner.running&&!Ne.runner.dead){const l=Ne.runner.runSpeed>20?.01:.02;for(ao+=r;ao>l;){ao-=l;const c=$n%zi;Pt[c*3]=t+(Math.random()-.5)*.5,Pt[c*3+1]=.1+Math.random()*.3,Pt[c*3+2]=e+1.5+Math.random()*.5,ki[c]=1,$t[c*3]=(Math.random()-.5)*1.5,$t[c*3+1]=1+Math.random()*2,$t[c*3+2]=1+Math.random()*1.5,$n++}}if(Ne._characterId==="barbarian"&&Ne.state===1){const l=Math.min(1,(Ne.runner.runSpeed-15)/15);if(l>.1&&Math.random()<l*.3){const c=$n%zi;Pt[c*3]=t+(Math.random()-.5)*.8,Pt[c*3+1]=.5+Math.random()*1.5,Pt[c*3+2]=e+1+Math.random()*.5,ki[c]=.8+Math.random()*.2,$t[c*3]=(Math.random()-.5)*2,$t[c*3+1]=2+Math.random()*3,$t[c*3+2]=1+Math.random()*2,$n++}}else if(Ne._characterId==="knight"&&Ne.state===1&&Ne.runner.attacking)for(let l=0;l<3;l++){const c=$n%zi;Pt[c*3]=t+(Math.random()-.5)*1.5,Pt[c*3+1]=.8+Math.random()*1,Pt[c*3+2]=e-.5+Math.random()*.5,ki[c]=1,$t[c*3]=(Math.random()-.5)*4,$t[c*3+1]=1+Math.random()*2,$t[c*3+2]=-2+Math.random()*2,$n++}if(Ne.activePowerUps){const l=el.uniforms.uColor1.value,c=el.uniforms.uColor2.value;let h,d,u,p,g,_;const m=Ne.cosmeticsManager?Ne.cosmeticsManager.getTrailConfig():null;if(m&&m.particleColor){const b=m.particleColor;h=b[0],d=b[1],u=b[2],p=b[0]*.7+.3,g=b[1]*.7+.3,_=b[2]*.7+.3}else Ne._characterId==="barbarian"?(h=1,d=.25,u=0,p=1,g=.5,_=.1):(h=.3,d=.5,u=1,p=.7,g=.85,_=1);Ne.activePowerUps.Invincibility?(h=0,d=.9,u=1,p=.3,g=.6,_=1):Ne.activePowerUps.Shield?(h=.5,d=.2,u=1,p=.8,g=.5,_=1):Ne.activePowerUps.CoinMagnet?(h=1,d=0,u=1,p=1,g=.5,_=1):Ne.activePowerUps.SpeedBoost&&(h=1,d=.3,u=0,p=1,g=.6,_=0);const f=r*4;l.x+=(h-l.x)*f,l.y+=(d-l.y)*f,l.z+=(u-l.z)*f,c.x+=(p-c.x)*f,c.y+=(g-c.y)*f,c.z+=(_-c.z)*f}for(let l=0;l<zi;l++)ki[l]>0&&(ki[l]-=r*2,ki[l]<0&&(ki[l]=0),Pt[l*3]+=$t[l*3]*r,Pt[l*3+1]+=$t[l*3+1]*r,Pt[l*3+2]+=$t[l*3+2]*r,$t[l*3+1]-=r*3);xs.attributes.position.needsUpdate=!0,xs.attributes.aAlpha.needsUpdate=!0;const i=Ne.currentTheme||"roman",n=cx[i];if(qd.position.z=e,n&&(no=n,Wd.uniforms.uColor.value.set(n.color[0],n.color[1],n.color[2])),no){const l=no;for(let c=0;c<An;c++)ts[c]<=0?Math.random()<l.density&&(ii[c*3]=(Math.random()-.5)*40,ii[c*3+1]=8+Math.random()*10,ii[c*3+2]=(Math.random()-.5)*60,ts[c]=l.alpha*(.5+Math.random()*.5),Ml[c]=l.size*(.5+Math.random()),jn[c*3]=l.velX*(.5+Math.random()),jn[c*3+1]=l.velY*(.8+Math.random()*.4),jn[c*3+2]=l.velZ*(Math.random()-.5)*2):(ii[c*3]+=jn[c*3]*r,ii[c*3+1]+=jn[c*3+1]*r,ii[c*3+2]+=jn[c*3+2]*r,(ii[c*3+1]<-1||ii[c*3+1]>20)&&(ts[c]=0))}else for(let l=0;l<An;l++)ts[l]*=.95;if(Tn.attributes.position.needsUpdate=!0,Tn.attributes.aAlpha.needsUpdate=!0,Tn.attributes.size.needsUpdate=!0,Ne._themeTransitionTimer>0||Ne._prevTheme!==Ne.currentTheme){const l={roman:{sky:[.35,.45,.55],fog:[.3,.4,.5],fogDensity:.008},forest:{sky:[.2,.35,.18],fog:[.2,.35,.2],fogDensity:.008},desert:{sky:[.5,.45,.3],fog:[.5,.45,.35],fogDensity:.006},lava:{sky:[.65,.35,.18],fog:[.6,.32,.16],fogDensity:.004},snow:{sky:[.5,.55,.6],fog:[.5,.55,.6],fogDensity:.007}},c=l[Ne.currentTheme]||l.roman,h=ct.background;h.r+=(c.sky[0]-h.r)*r*2,h.g+=(c.sky[1]-h.g)*r*2,h.b+=(c.sky[2]-h.b)*r*2,ct.fog&&(ct.fog.color.r+=(c.fog[0]-ct.fog.color.r)*r*2,ct.fog.color.g+=(c.fog[1]-ct.fog.color.g)*r*2,ct.fog.color.b+=(c.fog[2]-ct.fog.color.b)*r*2,ct.fog.density+=(c.fogDensity-ct.fog.density)*r*2)}const s=Rh[Ne.currentTheme]||Rh.roman,a=r*2;Et.set(s.sun.color),xt.color.lerp(Et,a),xt.intensity+=(s.sun.intensity-xt.intensity)*a,Et.set(s.fill.color),is.color.lerp(Et,a),is.intensity+=(s.fill.intensity-is.intensity)*a,Et.set(s.rim.color),ns.color.lerp(Et,a),ns.intensity+=(s.rim.intensity-ns.intensity)*a,Et.set(s.hemi.sky),Dh.set(s.hemi.ground),Gs.color.lerp(Et,a),Gs.groundColor.lerp(Dh,a),Gs.intensity+=(s.hemi.intensity-Gs.intensity)*a,Et.set(s.ambient.color),Jr.color.lerp(Et,a),Jr.intensity+=(s.ambient.intensity-Jr.intensity)*a,ss.strength+=(s.bloom.strength-ss.strength)*a,ss.threshold+=(s.bloom.threshold-ss.threshold)*a,Ct.toneMappingExposure+=(s.exposure-Ct.toneMappingExposure)*a;const o=Ih[Ne.currentTheme]||Ih.roman;Et.set(o.top),Jn.uniforms.topColor.value.lerp(Et,a),Et.set(o.mid),Jn.uniforms.midColor.value.lerp(Et,a),Et.set(o.horizon),Jn.uniforms.horizonColor.value.lerp(Et,a),Et.set(o.bottom),Jn.uniforms.bottomColor.value.lerp(Et,a)}Ts.render()}
